                ...
                <form action="{{route('admin.business-settings.update-setup')}}" method="post"
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 col-12">
                            <div class="form-group">
                                <label class="input-label" for="exampleFormControlInput1">{{trans('messages.opening')}} {{trans('messages.time')}}</label>
                        ...
                        <div class="col-md-4 col-12">
                            <div class="form-group">
                                <label class="input-label" for="exampleFormControlInput1">{{trans('messages.closing')}} {{trans('messages.time')}}</label>
